<?php
	$extension = strtolower(pathinfo($_FILES['pb']['name'], PATHINFO_EXTENSION));
	...
	if (!empty($extension)) {
		...
		if(function_exists('exif_imagetype')) { // Die exif_imagetype-Funktion erfordert die exif-Erweiterung auf dem Server
			...
			$detected_type = exif_imagetype($_FILES['pb']['tmp_name']);
		...
		if (!$pb_error) {
			...
			move_uploaded_file($_FILES['pb']['tmp_name'], $new_path);
